...
| `NODE_CAMERA_ADDRESS`              | `integer` \| `string`    | `0`                        | The camera device to use. An integer index (e.g. 0) selects by device order on Windows/Mac; a device path string (e.g. '/dev/video0') is used on Linux.                | `0`                        |
